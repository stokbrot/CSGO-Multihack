            ...
            if entity and entity != localPlayer:
                ...
                if entity_hp > 0 and not entity_dormant and Entspotted and entity_team != player_team:
                    ...
                    if baim is True:
                        ...
                        entitypos.x = pm.read_float( entity_bone + 0x30 * aimat + 0xC )
                        entitypos.y = pm.read_float( entity_bone + 0x30 * aimat + 0x1C )
                        entitypos.z = pm.read_float( entity_bone + 0x30 * aimat + 0x2C )
